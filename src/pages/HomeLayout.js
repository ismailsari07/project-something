...
export default function HomeLayout() {
    ...
    return (
        <>
            <nav id="nav-bar" className="flex flex-wrap justify-between items-center lg:px-6 lg:pt-3">
                <a className="logo-section grow basis-0">
                    <NavLink to="/" className="text-2xl leading-5 font-semibold dark:text-white">
                        Procer
                    </NavLink>
                </a>
                <div className="flex items-center lg:order-2 justify-end grow basis-0">
                    <ThemeToggle>
                    ...
                    {isThereUser ? (
                        <div className="flex">
                            <div className="profile-logo text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-pen">
                        ...
                        <div className="flex">
                            <NavLink
                                to="/login"
                                state={{ return_url: "login" }}
                                className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                            >
                                Log In
                            </NavLink>
                            <NavLink
                                to="/singup"
                                state={{ return_url: "signup" }}
                                className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                            >
                                Signup
                            </NavLink>
                        </div>
            ...
            <footer id="footer" className="footer-section flex justify-between py-14 items-start">
